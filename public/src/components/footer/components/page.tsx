    ...
    return (
      <main className="fixed bottom-0 w-full h-14 bg-gray-900 z-10">
        <div className="w-full h-full flex flex-row items-center px-4 py-1">
            <span onClick={() => openModal('profile')} className="w-1/5 group relative flex flex-col items-center justify-center text-white cursor-pointer"><Tooltip Icon={<FaUser />} Text="Perfil"/></span>
