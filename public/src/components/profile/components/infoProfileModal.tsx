  ...
  return (
    <form method="POST" onSubmit={onSubmit} className="relative w-full h-full flex flex-col gap-2 justify-start items-center px-2 lg:flex-row">
      <div className='flex flex-col items-center justify-center -mt-6'>
        <Image onClick={handleFramenClick} width={480} height={480} src={`/assets/demo/xFrame${session?.user.frame}.png`} className="h-40 w-auto object-contain rounded-md z-0 cursor-pointer" alt=""/>
        {registrationSuccess ? (
