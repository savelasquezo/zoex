              ...
              <div className="flex flex-col w-full h-full mt-8 mb-2 gap-y-4">
                <div className={`w-full h-full px-4 ${paymentInfo === '' ? 'block' : 'hidden' }`}>
                  ...
                  <div className="relative w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-3">
                    <span onClick={() => {if (paymentMethod === 'crypto') {setPaymentMethod('');} else {setPaymentMethod('crypto');}}} className=""><Image width={405} height={200} src={"/assets/image/bitcoin.webp"} className={`rounded-lg shadow-inherit h-12 w-22 object-fit hover:scale-[1.05] transition-transform duration-300  ${paymentMethod === 'crypto' ? 'opacity-100' : 'opacity-80'}`} alt="" /></span>
                    <span onClick={() => {if (paymentMethod === 'bank') {setPaymentMethod('');} else {setPaymentMethod('bank');}}} className=""><Image width={405} height={200} src={"/assets/image/bank.webp"} className={`rounded-lg shadow-inherit h-12 w-22 object-fit hover:scale-[1.05] transition-transform duration-300" ${paymentMethod === 'bank' ? 'opacity-100' : 'opacity-80'}`} alt="" /></span>
                    ...
                    <span onClick={() => {if (paymentMethod === 'nequi') {setPaymentMethod('');} else {setPaymentMethod('nequi');}}} className=""><Image width={405} height={200} src={"/assets/image/nequi.webp"} className={`rounded-lg shadow-inherit h-12 w-22 object-fit hover:scale-[1.05] transition-transform duration-300" ${paymentMethod === 'nequi' ? 'opacity-100' : 'opacity-80'}`} alt="" /></span>
                    <span onClick={() => {if (paymentMethod === 'daviplata') {setPaymentMethod('');} else {setPaymentMethod('daviplata');}}} className=""><Image width={405} height={200} src={"/assets/image/daviplata.webp"} className={`rounded-lg shadow-inherit h-12 w-22 object-fit hover:scale-[1.05] transition-transform duration-300" ${paymentMethod === 'daviplata' ? 'opacity-100' : 'opacity-80'}`} alt="" /></span>
                  </div>
                </div>
            ...
            <div className={`w-full h-full ${activeSubTab === 'withdraw' ? 'block' : 'hidden' }`}>
              ...
              <div className="flex flex-col w-full h-full mt-8 mb-2 gap-y-4">
                <div className={`w-full h-full px-4 ${withdrawInfo === '' ? 'block' : 'hidden' }`}>
                  ...
                  <div className="relative w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-3">
                    <span onClick={() => {if (withdrawMethod === 'crypto') {setWithdrawMethod('');} else {setWithdrawMethod('crypto');}}} className=""><Image width={405} height={200} src={"/assets/image/bitcoin.webp"} className={`rounded-lg shadow-inherit h-12 w-22 object-fit hover:scale-[1.05] transition-transform duration-300 ${withdrawMethod === 'crypto' ? 'opacity-100' : 'opacity-80'}`} alt="" /></span>
                    <span onClick={() => {if (withdrawMethod === 'bank') {setWithdrawMethod('');} else {setWithdrawMethod('bank');}}} className=""><Image width={405} height={200} src={"/assets/image/bank.webp"} className={`rounded-lg shadow-inherit h-12 w-22 object-fit hover:scale-[1.05] transition-transform duration-300" ${withdrawMethod === 'bank' ? 'opacity-100' : 'opacity-80'}`} alt="" /></span>
                    <span onClick={() => {if (withdrawMethod === 'paypal') {setWithdrawMethod('');} else {setWithdrawMethod('paypal');}}} className=""><Image width={405} height={200} src={"/assets/image/paypal.webp"} className={`rounded-lg shadow-inherit h-12 w-22 object-fit hover:scale-[1.05] transition-transform duration-300" ${withdrawMethod === 'paypal' ? 'opacity-100' : 'opacity-80'}`} alt="" /></span>
                    <span onClick={() => {if (withdrawMethod === 'nequi') {setWithdrawMethod('');} else {setWithdrawMethod('nequi');}}} className=""><Image width={405} height={200} src={"/assets/image/nequi.webp"} className={`rounded-lg shadow-inherit h-12 w-22 object-fit hover:scale-[1.05] transition-transform duration-300" ${withdrawMethod === 'nequi' ? 'opacity-100' : 'opacity-80'}`} alt="" /></span>
                    <span onClick={() => {if (withdrawMethod === 'daviplata') {setWithdrawMethod('');} else {setWithdrawMethod('daviplata');}}} className=""><Image width={405} height={200} src={"/assets/image/daviplata.webp"} className={`rounded-lg shadow-inherit h-12 w-22 object-fit hover:scale-[1.05] transition-transform duration-300" ${withdrawMethod === 'daviplata' ? 'opacity-100' : 'opacity-80'}`} alt="" /></span>
                  </div>
                </div>
